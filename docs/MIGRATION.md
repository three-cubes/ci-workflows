...
jobs:
  deploy:
    uses: three-cubes/platform-templates/.github/workflows/azure-vm-deploy.yml@v1
    with:
...
uses: three-cubes/platform-templates/.github/workflows/azure-vm-deploy.yml@<known-good-sha>
```
